...
tmp<volScalarField> LaunderSharmaKEYap<BasicTurbulenceModel>::fMu() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> LaunderSharmaKEYap<BasicTurbulenceModel>::f2() const
{
    return
        scalar(1)
...
template<class BasicTurbulenceModel>
tmp<volScalarField> LaunderSharmaKEYap<BasicTurbulenceModel>::sYap() const
{
...
template<class BasicTurbulenceModel>
void LaunderSharmaKEYap<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> LaunderSharmaKEYap<BasicTurbulenceModel>::kSource() const
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> LaunderSharmaKEYap<BasicTurbulenceModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicTurbulenceModel>
LaunderSharmaKEYap<BasicTurbulenceModel>::LaunderSharmaKEYap
(
...
template<class BasicTurbulenceModel>
bool LaunderSharmaKEYap<BasicTurbulenceModel>::read()
{
    if (eddyViscosity<RASModel<BasicTurbulenceModel>>::read())
    {
        ...
        Cyap_.readIfPresent(this->coeffDict());
...
template<class BasicTurbulenceModel>
void LaunderSharmaKEYap<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
